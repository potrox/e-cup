...
from ecup_matching.serialization import ITEM_SERIALIZER_VERSION
...
class EnsembleBundle:
    ...
    def load(cls, bundle_root: Path) -> EnsembleBundle:
        ...
        for model in manifest.get("models", []):
            ...
            if inference.get("bidirectional") is not False:
                raise ValueError("current ensemble release supports one-direction models only")
    ...
    for model in bundle.models:
        ...
        for max_length, active in length_masks.items():
            ...
            scores[active] = _score_neural_pairs(
                ...
                names1=names1[active],
                attributes1=attributes1[active],
                names2=names2[active],
